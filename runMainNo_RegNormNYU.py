...
cmd503 = 'py  train.py --gpu 0  --cfg NO_UKER_regnorm_NYU_TL'
cmd504 = 'py  predict.py --gpu 0  --cfg NO_UKER_regnorm_NYU_TL --ckpt model_last.tar --folder testUKER --valid_list testUKER.txt'
cmd505 = 'py  predict.py --gpu 0  --cfg NO_UKER_regnorm_NYU_TL --ckpt model_last.tar --folder testNYU --valid_list testNYU.txt'
...
cmd550 = 'py  train_LWF.py --gpu 0  --cfg NO_UKER_regnorm_NYU_LWF'
cmd551 = 'py  predict.py --gpu 0  --cfg NO_UKER_regnorm_NYU_LWF --ckpt model_last.tar --folder testUKER --valid_list testUKER.txt'
cmd552 = 'py  predict.py --gpu 0  --cfg NO_UKER_regnorm_NYU_LWF --ckpt model_last.tar --folder testNYU --valid_list testNYU.txt'
