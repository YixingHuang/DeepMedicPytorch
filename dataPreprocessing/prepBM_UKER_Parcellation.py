...
def process(path, parce_path, has_label=True, n_channels=1):
    ...
    t1 = np.array(nib_load(path[:-1] + '.nii.gz'), dtype='float32', order='C')
...
args.data_dir = 'C:/Data/UKER_BM_parcellation'
args.test_data_dir = 'C:/Data/UKER_BM_parcellation'
args.parcellation_train_dir = 'C:/Data/UKER_brain_parcellation/HarvardOxford-sub/'
args.parcellation_test_dir = 'C:/Data/UKER_brain_parcellation/HarvardOxford-sub/'
