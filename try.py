...
checkpoint = torch.load('C:/MachineLearning/DeepMedicPytorch/Yixing/BM_train_ckpts/deepmedic_jvssPr_BM/model_last.tar')

for key in checkpoint['state_dict']:
    # print(key, torch.sum(checkpoint['state_dict'][key]))
    print(key)
